...
IfWinNotExist, ahk_exe Notion.exe
	Run, "C:\Users\Caivy\AppData\Local\Programs\Notion\Notion.exe"
...
IfWinNotExist, ahk_exe Discord.exe ; ;
	Run, "C:\Users\Caivy\AppData\Local\Discord\Update.exe" --processStart Discord.exe ; this is the exact path with command line parameters(the processStart part) i got from the discord shortcut on my taskbar
