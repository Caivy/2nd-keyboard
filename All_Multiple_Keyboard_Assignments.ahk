...
;SetTitleMatchMode, 2 ; Set the matching mode to search for window titles that contain the specified string

#IfWinActive, ahk_exe firefox.exe ; Only apply the hotkeys to Google Chrome

!g::
    GroupActivate, browserGroup, r
return
F1::
...
CapsLock & 2::switchToFireFox() ; I switched to brave, it's faster, I would like to have firefox with chrome extensions and chrome settings/flags
...
CapsLock & 4::instantExplorer("E:\")
CapsLock & 5::instantExplorer("F:\")
CapsLock & 6::instantExplorer("F:\Neonz Reacts")
CapsLock & 7::instantExplorer("C:\Users\Caivy\Downloads")
CapsLock & 8::instantExplorer("C:\Users\Caivy\Pictures")
CapsLock & 9::return
CapsLock & 0::return
...
; Top Row
CapsLock & q::switchToPhotoshop()
CapsLock & w::switchToNotion()
CapsLock & e::lookup()
CapsLock & r::winRestoreMaximize()
CapsLock & t::instantExplorer("F:\Neonz Reacts") ; Projects folder
CapsLock & y::return
; CapsLock & y::instantExplorer("C:\Users\Caivy\Downloads") ; this is without the onedrive if you don't have onedrive
...
CapsLock & d::Right
CapsLock & f::^f19
CapsLock & g::instantExplorer("C:\Users\Caivy")
...
CapsLock & v::instantExplorer("C:\AHK\2nd-keyboard-main")
CapsLock & b::Delete
...
CapsLock & F4::
send, c ;This is my Premiere shortcut for the RAZOR tool. You can use another shortcut if you like, but you have to use that shortcut here.
...
#include %A_ScriptDir%\Almost_All_Premiere_Functions.ahk
#include %A_ScriptDir%\Almost_All_Windows_Functions.ahk
;#include %A_ScriptDir%\Right_Click_Timeline.ahk
#include %A_ScriptDir%\look_up.ahk
#include %A_ScriptDir%\dragger.ahk
;#include  C:\AHK\2nd-keyboard-main\Almost_All_Premiere_Functions.ahk
